...
// This program demonstrate important concepts abouot the Array
...
//////////////////////////////////////////////////////////////////////////////
	...
	// We can provide compile constant while creating array.                88
...
//////////////////////////////////////////////////////////////////////////////
	...
	// remainning members are initialised with 0,0.0,'\0'
	int arr6[10] = {10,20,30,40};
	printf("Value of uninitialised member of array is %d\n",arr6[4]);

//////////////////////////////////////////////////////////////////////////////

	// We can not initialise the elements greater than size of the array as c++ performs strict 
