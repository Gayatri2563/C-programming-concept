...
int main()
{
	...
	printf("Contents of integer pointer ip pointning to i : %u\n",ip);
	...
	printf("Contents of double pointer dp pointning to d : %u\n",dp);
	...
	if(parr1 == parr2)
	{
		printf("Pointers pointing to an array are equal\n");
	}
