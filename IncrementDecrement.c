...
int main()
{
   ...
   ++a;
   printf("Value of after preincrement is %d\n",a);

   a++;
   printf("Value of after postincrement is %d\n",a);
   ...
   --a;
   printf("Value of after predecremet is %d\n",a);
 
   a--;
   printf("Value of after postdecremet is %d\n",a);
   return 0;
}